...
let arrr=[1,2,3,4];
arrr.forEach(function print(num){
console.log(num);
});

//converting above function to an array function
console.log("for each loop in arrow function")
arrr.forEach(no=> console.log(no));

//join,split
let new_arr=arrr.join("-");
console.log(new_arr);
